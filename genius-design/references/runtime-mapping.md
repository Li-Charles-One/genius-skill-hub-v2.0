...
# Mode A (optional): read references/brands.md or webfetch VoltAgent GitHub raw directly into $stage/base.md
...
Version 3.3.0 is exercised on Windows/Python 3.12. macOS/Linux paths are designed to be portable but remain unverified there. Reference snapshots use standard webfetch when requested.
