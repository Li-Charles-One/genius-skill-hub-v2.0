...
2. For a named reference without supplied material, fetch a base into the staging directory using `scripts/fetch_design_md.py <brand> <staging>/base.md`.
...
2. Run `scripts/lint_design_md.py <candidate>`. Resolve all FAILs and review WARNs. Complete the human specification checklist separately.
